 ...
 */
- (NSURLRequest *)userTokenAuthorizationRequest:(NSArray *)otherParameters;
...
/** 
 ...
 This value can be assigned to an already cached access token for future authorized requests.
 @note This value is updated before the completion handler of one of the two requests.
 */
@property (nonatomic, strong) NSString *token;

/**
 The most recent secret token. You can use this to check the authorized secret token returned by
 the web view. This value can be assigned to an already cached secret token for future authorized
 requests.
 @note This value is updated before the completion handler of one of the two requests.
 */
